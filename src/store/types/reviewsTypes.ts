...
export enum ReviewsActionTypes {
  ...
  SET_CURRENT_ACCOMMODATION_PAGE = 'SET_CURRENT_ACCOMMODATION_PAGE',
}
...
interface IReviewsSetCurrentPageAction {
  type: ReviewsActionTypes.SET_CURRENT_PAGE;
  payload: number;
}

interface IReviewsSetCurrentAccommodationPageAction {
  type: ReviewsActionTypes.SET_CURRENT_ACCOMMODATION_PAGE;
  payload: number;
}
...
export type ReviewsAction =
  ...
  | IReviewsSetCurrentPageAction
  | IReviewsSetCurrentAccommodationPageAction;
