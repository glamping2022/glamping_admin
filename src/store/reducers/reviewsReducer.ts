...
const reviewsReducer = (state = initialState, action: ReviewsAction): IReviewsState => {
  switch (action.type) {
    case ReviewsActionTypes.SET_CURRENT_PAGE:
      return { ...state, currentPage: action.payload };
    case ReviewsActionTypes.SET_CURRENT_ACCOMMODATION_PAGE:
      return { ...state, currentAccommodationReviewPage: action.payload };
    ...
    //   }
    //   return { ...state, reviews: data, currentPage: action.page + 1 };
    // }
    // case ReviewsActionTypes.FETCH_REVIEWS_FAILURE:
    //   return { ...state, error: action.payload };
    ...
    case ReviewsActionTypes.FETCH_ACCOMMODATION_REVIEWS_SUCCESS: {
      ...
      return { ...state, accommodationReviews: data, currentAccommodationReviewPage: action.page + 1 };
    }
